namespace Templar.Datas.Unit.Enemy
{
    ...
    public class SkeletonFightBehaviourDatas : ScriptableObject
    {
        ...
        [Header("ATTACK")]
        [SerializeField] private Attack.SkeletonAttackDatas _baseAttack = null;
        [SerializeField] private Attack.SkeletonAttackDatas _aboveAttack = null;
        ...
        public Attack.SkeletonAttackDatas BaseAttack => _baseAttack;
        public Attack.SkeletonAttackDatas AboveAttack => _aboveAttack;
    }
}