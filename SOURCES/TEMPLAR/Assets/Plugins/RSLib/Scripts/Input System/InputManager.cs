namespace RSLib.Framework.InputSystem
{
    ...
    public class InputManager : Singleton<InputManager>
    {
        ...
        public static void AssignKey(InputAction action, bool atnBtn)
        {
            if (IsAssigningKey)
                return;

            s_assignKeyCoroutine = AssignKeyCoroutine(action, atnBtn);
        ...
        private static System.Collections.IEnumerator AssignKeyCoroutine(InputAction action, bool alt)
        {
