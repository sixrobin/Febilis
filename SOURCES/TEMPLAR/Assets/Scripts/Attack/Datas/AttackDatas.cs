namespace Templar.Attack.Datas
{
    ...
    public class AttackDatas : ScriptableObject
    {
        ...
        [SerializeField] private HitDirComputationType _hitDirComputationType = HitDirComputationType.ATTACK_DIR;
        ...
        public HitDirComputationType HitDirComputationType => _hitDirComputationType;
