namespace Templar
{
    ...
    public class LocalizationManager : RSLib.Framework.ConsoleProSingleton<LocalizationManager>
    {
        ...
        public static string Get(string key)
        {
            ...
            Instance.LogWarning($"Key {key} could not be found for language {Instance.Language}!");
            return key;
        }
