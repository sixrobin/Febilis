namespace Templar.Camera.Datas
{
    ...
    public class CameraDatas : ScriptableObject
    {
        ...
        [Tooltip("Damping applied to camera X when looking ahead.")]
        ...
        [Tooltip("Damping applied to camera Y when looking up or down.")]
        [SerializeField] private float _verticalLookAheadDamping = 2f;

        [Tooltip("Distance added to camera Y when looking ahead.")]
        [SerializeField] private float _verticalLookAheadDist = 2f;

        [Tooltip("Delay before looking up or down.")]
        [SerializeField] private float _verticalLookAheadDelay = 0.4f;
        ...
        public float VerticalLookAheadDamping => _verticalLookAheadDamping;
        public float VerticalLookAheadDist => _verticalLookAheadDist;
        public float VerticalLookAheadDelay => _verticalLookAheadDelay;
