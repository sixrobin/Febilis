namespace Templar.Tools
{
    ...
    [System.Serializable]
    public struct OptionalBoard
    {
        [SerializeField] private Board _value;
        [SerializeField] private bool _enabled;

        public OptionalBoard(Board initValue)
        {
            _value = initValue;
            _enabled = true;
        }

        public OptionalBoard(Board initValue, bool initEnabled)
        {
            _value = initValue;
...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(OptionalBoard))]
    public class OptionalBoardPropertyDrawer : PropertyDrawer
    {
